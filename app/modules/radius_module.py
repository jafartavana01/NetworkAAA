...
from ..api.routes_radius_policies import router as radius_policies_router
...
def _build_module() -> Module:
    ...
    combined.include_router(radius_policies_router)
